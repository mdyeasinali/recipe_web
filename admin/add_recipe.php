<?php 
  ...
  $row = $categories->category();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
	  if(empty($_REQUEST['recipe_name'])||
	    empty($_REQUEST['rec_cat']))
		{
		 	$admin->url_return(array('add_recipe.php','Some of fields is empty','error',$_POST['token']));
		  }else{
			  ...
			  $tkn = $_POST['token'];
			  $Recipe->add_Recipe($recipe_name,$cat_id,$dis,$rec_u_id,$rec_cat,$tkn,'img');
			  }
            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Recipe Page</li>
                    </ul>
                ...
                <div class="row-fluid">
						...
						<div class="box gradient">
                               ...
                               <div class="title">
                                    <h4>
                                        <span class="eco-list ">Add Recipe</span>
                             ...
                             <div class="content noPad clearfix">
                              <form class="form-horizontal" id="form-validate" action="<?php echo $_['action']; ?>" method="post" enctype="multipart/form-data">           
                               ...
                               <input type="hidden" name="rec_u_id" value="<?php echo $admin->admin_data('user_id') ?>" />
                                    ...
                                    <div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												...
												<input type="text" class="span9 required " id="required"  name="recipe_name" placeholder="Recipe Title "  />
											</div>
										</div>
									</div> 
                                    <div class="form-row row-fluid">
												<div class="span12">
													<div class="row-fluid">
														...
														<input type="text" id="autocomplete" placeholder="Recipe Category" name="rec_cat" class="span9" />
														<script>
																	$(function(){
																	var currencies = [
                                            ...
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Description</label>
						                                  ...
						                                  <div class="form-row">
						                                      <textarea class="tinymce" name="dis" style="width:75%;"></textarea>
						                                  </div>
                                        ...
                                        <div class="span12">
                                            <div class="row-fluid">
                                                ...
                                                <div class="left marginR10">
                                                    <input type="checkbox" id="inlineCheckbox4" name="cat_top" class="ibutton nostyle" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span9 disabled" id="disabledInput" name="recipe_seo_keyword" type="text" placeholder="Disabled SEO Keyword…" disabled="disabled" />
                                                </div>
                                            </div>
                                        </div>
