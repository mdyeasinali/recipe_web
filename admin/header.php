        ...
        <div class="navbar">
            <div class="navbar-inner">
              <div class="container-fluid">
                <a class="brand" href="index.php<?php echo $_['url_prm']; ?>">Supr.<span class="slogan">admin</span></a>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li class="menu">
                                    <ul>
                                        <li>                                                    
                                            <a href="frontend.php<?php echo $_['url_prm']; ?>"><span class="icon16 icomoon-icon-wrench"></span>Site config</a>
                                        </li>	
                                        <li>                                                    
                                            <a href="slider.php<?php echo $_['url_prm']; ?>"><span class="icon16 icomoon-icon-equalizer"></span>Slider Setting</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                    ...
                    <ul class="nav pull-right usernav">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle avatar" data-toggle="dropdown">
                                ...
                                <img src="../<?php  echo $admin->admin_data('user_img'); ?>" alt="" class="image" /> 
                            ...
                            <ul class="dropdown-menu">
                                <li class="menu">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="admin_pass.php<?php echo $_['url_prm'] ?>"><span class="icon16 icomoon-icon-comments-2"></span>Change Password </a>
                                        </li>
                                        <li>
                                            <a href="add_user.php<?php echo $_['url_prm'] ?>"><span class="icon16 icomoon-icon-plus-2"></span>Add Partner</a>
                                        </li>
                                    </ul>
