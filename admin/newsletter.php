<?php 
  ...
  require_once('../include/news_class.php');
  ...
  $admin->check_admin_token($token);
   ...
   if($_SERVER['REQUEST_METHOD'] == "POST"){		
	...
	$newsletter->delete_news($delecte_id,$tkn);		
	} 
                ...
                <div id="content" class="clearfix">
                    ...
                    <div class="heading">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Newsletter Page</li>
                        </ul>
                                         ...
                                         <thead>
                                          ...
                                          <tbody>
                                            ...
                                            <tr class="even gradeC">
                                                ...
                                                <td><?php echo   $key['news_em'];  ?></td>                                     
                                               <td><?php echo  $key['news_user_agent']; ?></td> 
                                               <td><?php echo  $key['news_ip']; ?></td>                                               
                                                <td><?php echo  $key['news_st']; ?></td>                                               
