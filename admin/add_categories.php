 ...
 if($_SERVER['REQUEST_METHOD'] == "POST"){
	  if(empty($_POST['cat_name'])||
	    empty($_REQUEST['cat_des'])){
		 	$admin->url_return(array('add_categories.php','Some of fields is empty',$tkn));
		  }else{
			  $ct = $_POST['cat_name'];
                                      ...
                                      <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input class="span9" id="required" name="cat_name" placeholder="Category Name" type="text" />
                                                </div>
                                            </div>
                                        </div>
									  ...
									  <div class="form-row row-fluid">
                                            <div class="span12">
                                                ...
                                                <label class="form-label span2" for="required"><b>Description</b></label>
                                                    <textarea class="tinymce " name="cat_des" style="width:75%;"></textarea>
                                                </div>
                                            </div>
                                        </div>
											...
											<div class="form-row row-fluid">
												<div class="span12">
													<div class="row-fluid">
														...
														<img  id="uploadPreview"  style="height:70px; width:70px;" data-placeholder="imglibrary/autoimage/no_image-100x100.png" class="image marginR10" src="images/Blank-person-photo-e1372195842442.png" alt="" >
											...
											<div class="span12">
												<div class="row-fluid">												
													...
													<div class="left marginR10">
														<input type="checkbox" id="inlineCheckbox4" name="cat_top" checked="checked" class="ibutton nostyle" /> 
													</div>
												</div>
											</div>
										</div>										
