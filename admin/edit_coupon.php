<?php 
  ...
  $row = $categories->category();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
			  ...
			  $col = $_POST['col'];
			  $c_des = $_POST['des'];
			  $date_pic = $_POST['datepic'];
			  $cp = $_POST['cp'];
			  $cou_fea = $_POST['cou_fea'];			  
			  $tkn = $_POST['token'];
			  $hidden_img = $_POST['hidden_img'];
			  $cou_id = $_POST['cou_id'];
			  $co = $_POST['co'];
			  
			  $Recipe->Recipe_update($cat_id,$ct,$c_des,$con,$courl,$col,$cd,$date_pic,$cp,$co,$cou_fea,$tkn,'img',$hidden_img,$cou_id,$co);
			  }	
						...
						<div class="box gradient">
                             ...
                             <div class="content noPad clearfix">
                              <form class="form-horizontal" id="form-validate" action="<?php echo $_['action']; ?>" method="post" enctype="multipart/form-data">         
								...
								<input type="hidden" name="cou_id" value="<?php echo $Recipe_id;  ?>" />
								<input type="hidden" name="co_cate" value="<?php echo $val['cat_id']; ?>" />	
                                    ...
                                    <div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												...
												<input type="text" class="span9 required " value="<?php echo $val['title']; ?>" id="required"  name="ct" placeholder="Recipe Title "  />
											</div>
										</div>
									</div> 
                                    <div class="form-row row-fluid">
												<div class="span12">
													<div class="row-fluid">
														...
														<input type="text" id="autocomplete" placeholder="Recipe Category" name="cou_cat" class="span9" value="<?php echo $val['cat']; ?>" />
														<script>
																  ...
																  $('#autocomplete').autocomplete({
																	...
																	onSelect: function (suggestion) {
																	  var thehtml = '<input type="hidden" name="c_cat_id" value="' + suggestion.cat_id + '" /> ';
																	  $('#hides').html(thehtml);
																	}
																  });
                                            ...
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Description</label>
						                                  ...
						                                  <div class="form-row">
						                                      <textarea class="tinymce" name="des" style="width:75%;"><?php echo $val['dis']; ?></textarea>
						                                  </div>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Owner name</label>
                                                    <input type="text" class="span9 " id="required" name="con" value="<?php echo $val['owner']; ?>"placeholder="Recipe Owner name"  />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Owner URL</label>
                                                    <input type="text" class="span9 " id="required" name="courl" value="<?php echo $val['url']; ?>" placeholder="Recipe Owner URL"  />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Owner location</label>
                                                    <input type="text"  class="span9"placeholder="Recipe Owner location" value="<?php echo $val['location']; ?>" id="email" name="col" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">code</label>
                                                    <input type="text"  class="span9 required"placeholder="Recipe code" value="<?php echo $val['code']; ?>" id="email" name="cd" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Price</label>
                                                    <input type="text"  class="span9 required"placeholder="Recipe Price"value="<?php echo $val['price']; ?>"  id="email" name="cp" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Discount percentage</label>
                                                    <input type="text"  class="span9"placeholder=" Recipe Discount percentage" value="<?php echo $val['off']; ?>" id="email" name="co" />
                                                </div>
                                            </div>
                                        </div> 
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <label class="form-label span2" for="checkboxes">Date picker</label>
                                                    <div class="span9">
                                                        <input type="text" name="datepic" value="<?php echo $val['ex']; ?>" id="datepicker" />
                                                    </div>
                                                </div>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">												
													<label class="form-label span2" for="username">Feature</label>
													<div class="left marginR10">
														<select name="cou_fea">                                                        	
                                                        	<option <?php if($val['fea'] == '0'){echo 'selected="selected"';} ?> value="0">--None--</option>                        
                                                            <option  <?php if($val['fea'] == '1'){echo 'selected="selected"';} ?> value="1">--Hot Sale(Red)--</option>
                                                            
                                                            <option <?php if($val['fea'] == '2'){echo 'selected="selected"';} ?> value="2">--Trusted Brand(Yellow)--</option>
                                                            
                                                            <option <?php if($val['fea'] == '3'){echo 'selected="selected"';} ?> value="3">--Trusted Brand(Blue)--</option>
