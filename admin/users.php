                              ...
                              <div class="box gradient">
                                 ...
                                 <div class="title">
                                      <h4>
                                          ...
                                          <a href="add_user.php<?php echo $_['url_prm']; ?>"><span class="label btn btn-primary btn-mini">Add New</span></a>
                                      </h4>
                                  </div>
                                         ...
                                         <thead>
                                          ...
                                          <tbody>
                                            ...
                                            <td class="chChildren"><input type="checkbox" name="check_list[]" value="<?php echo $key['id']; ?>" class="styled" /></td>
                                                ...
                                                <td><a href="" ><img class="image marginR9" style="height:40px; width:50px; border="1px"" src="../<?php echo  $key['u_img']; ?>"/></a></td>
                                                <td>
  													<div class="controls center">
  														<a href="update_user.php?u_id=<?php echo $key['id'];?>&token=<?php echo $token ?>" title="Edit task"  class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
