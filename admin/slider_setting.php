	  ...
	  if(empty($_REQUEST['fn'])||
		...
		empty($_REQUEST['ad2']))
		{
		 	$admin->url_return(array('add_user.php','Some of fields is empty','eror',$_POST['token']));
				  ...
				  $ad2 = $_POST['ad2'];  
				  $tkn = $_POST['token'];
				  $users->add_user($fn,$ln,$em,$un,$pw, $cy,$pc,$st,$cu, $ad,$ad2,$tkn,'img');	  
				  }
            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Slider setting Page</li>
                    </ul>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span12">
						<div class="box gradient">
							...
							<div class="title">
								<h4>
									<span class="eco-list ">Add Slider</span>                                         
                            ...
                            <div class="content noPad clearfix">
								<!-- Build page from here: -->
								<div class="form-actions" style=" border-bottom: 10px solid #999;padding:0px 20px 20px">
									<span style="float:left; font-family:'Courier New', Courier, monospace; color:#349BB9">
										<h3>Add Slider</h3>
									</span>
									<a href="add_slider.php<?php echo $_['url_prm']; ?>">
										<span style="float:right">
											<button type="submit" class="btn btn-info iconic-icon-plus "></button>
										</span>
									</a>
									...
									<?php /* foreach($row as $key){ */ ?>
										...
										<form class="form-horizontal" id="form-validate" action="<?php echo $_['action']; ?>" method="post" enctype="multipart/form-data">
											...
											<div class="form-row row-fluid">
												<div class="span12">
													<div class="row-fluid">
														<label class="form-label span2" for="sdfsdf">Add Silader Link</label>
														<input class="span10 "type="text"  placeholder="Silader Link" name="video_title" value=" <?php /*echo $key['s_link'];*/?> "  />
													</div>
												</div>
											</div>
											...
											<div class="form-row row-fluid">
												<div class="span12">
													<div class="row-fluid">
														<label class="form-label span2" for="username">Add Thumbnail</label>
													  <img id="uploadPreview" style=" height:80px; width:80px; " data-placeholder="C:\xampp\htdocs\videoadmin\admin\imglibrary/thumbnail-default.jpg" src="<?php /* echo $key['s_thumbnail']; */?>" border="1px" class="image marginR10"/>
