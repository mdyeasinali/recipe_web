                ...
                <div id="content" class="clearfix">
                    ...
                    <div class="heading">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Categories page</li>
                        </ul>
                                  ...
                                  <table cellpadding="0" cellspacing="0" border="0" class="responsive dynamicTable display table table-bordered " width="500%" id="checkAll">
                                        ...
                                        <?php 
                                            ...
                                            <td class="chChildren"><input type="checkbox" name="check_list[]" value="<?php echo $key['id']; ?>" class="styled" /></td>
                                                ...
                                                <td><a href="" ><?php echo  $key['on_menu'];  ?></td>
                                                <td>
  													<div class="controls center">
  														<a href="update_categories.php?cat_id=<?php echo $key['id']; ?>&token=<?php echo $token ?>" title="Edit task"  class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
