<?php 
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){		
	...
	$information->delete_information($delecte_id,$tkn);		
	}
                              ...
                              <div class="box gradient">
                                 ...
                                 <div class="title">
                                      <h4>
                                          ...
                                          <a href="add_information.php<?php echo $_['url_prm']; ?>"><span class="label btn btn-primary btn-mini">Add New</span></a>
                                      </h4>
                                  </div>
                                ...
                                <input type="hidden" name="token" value="<?php echo $token; ?>" />	
                                  <table cellpadding="0" cellspacing="0" border="0" class="responsive dynamicTable display table table-bordered " width="500%" id="checkAll">
                                        ...
                                        <?php $row = $information->information_list();foreach($row as $key){?>
                                            ...
                                            <td class="chChildren"><input type="checkbox" name="check_list[]" value="<?php echo  $key['id']; ?>" class="styled" /></td>
                                                ...
                                                <td>
  													<div class="controls center">
  														<a href="update_information.php?info_id=<?php echo $key['id'];?>&token=<?php echo $token;?>" title="Edit task"  class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
