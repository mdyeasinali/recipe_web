<?php 
  ...
  require_once('../include/customers_class.php');
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){	
	...
	$customer->delete_customers($delecte_id);		
	}
                            ...
                            <div class="box gradient">
                                ...
                                <div class="content noPad clearfix">
                                    <table cellpadding="0" cellspacing="0" border="0" class="responsive dynamicTable display table table-bordered" width="100%">
                                        ...
                                        <?php  $row = $customer->show_all_cus();
										  foreach( $row as $val){?>
                                            
                                            <tr class="even gradeC">
												<td class="chChildren"><input type="checkbox" name="check_list[]" value="<?php echo $val['customers_id']; ?>" class="styled" /></td>
                                                <td><?php echo  $val['customers_id']; ?></td>
                                                
                                                <td><?php echo  $val['customers_first_name']; ?><?php  echo  $val['customers_last_name']; ?></td>
                                                <td><?php echo  $val['customers_email']; ?></td>
                                                <td>
  													<div class="controls center">
  														<a href="edit_admin.php<?php echo $_['url_prm']; ?>" title="Edit task"  class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
