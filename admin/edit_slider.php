<?php 
  ...
  $row = $slider->edit_show_slider($sl_id);
            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Update Slider Page</li>
                    </ul>
                ...
                <div class="row-fluid">
						...
						<div class="box gradient">
                               ...
                               <div class="title">
                                    <h4>
                                        <span class="eco-list ">Update Slider</span>                                         
										...
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													...
													<input type="text" class="span9 required " value="<?php echo $val['title'];?>" id="required"  name="sl_name" placeholder="Slider Title "  />
												</div>
											</div>
										</div>
										<div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">
													...
													<input type="text" class="span9 " value="<?php  echo $val['url'];  ?>" id="required" name="sl_url" placeholder="Slider URL"  />
												</div>
											</div>
										</div>
										<div class="form-row row-fluid">
											...
											<div class="span12">
												<div class="row-fluid">												
													...
													<div class="left marginR10">
														<input type="checkbox" id="inlineCheckbox4" name="status" <?php echo $val['status'];  ?> class="ibutton nostyle" /> 
													</div>
												</div>
											</div>
										</div>
