<?php 
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){
	  if(empty($_REQUEST['fn'])||
		...
		empty($_REQUEST['ad']))
		{
		 	$admin->url_return(array('add_user.php','Some of fields is empty','eror',$_POST['token']));
		  }else{
			   	  $fn = $_POST['fn'];
				  $ln = $_POST['ln'];
				  $em = $_POST['em'];
				  ...
				  $ad2 = $_POST['ad2'];  
				  $tkn = $_POST['token'];
				  $users->add_user($fn,$ln,$em,$un,$pw,$ad,$ad2,$tkn,'img');	  
				  }
										...
										<div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input type="text" class="span9 required " id="required"  name="fn" placeholder="Partner First Name"  />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input type="text" class="span9 required" id="required" name="ln"placeholder="Partner Last Name"  />
                                                </div>
                                            </div>
                                        </div>                                        
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
												<label class="form-label span2" for="required">Username</label>
                                                    <input type="text" class="span9 required" id="required" placeholder="Username" name="un"  />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
												...
												<label class="form-label span2" for="required">Password</label>
                                                    <input type="password" class="span9 required" id="required" placeholder="Username" name="pw" />
                                                </div>
                                            </div>
                                        </div>                                       
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input type="text"  class="span9 required" id="email" name="em"placeholder="Email" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Address </label>
						                                  ...
						                                  <div class="form-row">
						                                      <textarea class="" name="ad" style="width:73%; height:100px"></textarea>
						                                  </div>
                                            ...
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Address 2</label>
						                                  ...
						                                  <div class="form-row">
						                                      <textarea class="" name="ad2" style="width:73%;height:100px"></textarea>
						                                  </div>
                                        ...
                                        <div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">											
                                                  ...
                                                  <img id="uploadPreview" style="height:60px; width:60px; " data-placeholder="images/Blank-person-photo-e1372195842442.png" src="images/Blank-person-photo-e1372195842442.png"  border="1px" class="image marginR10"/>
