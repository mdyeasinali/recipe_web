<?php 
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){
				  ...
				  $tkn = $_POST['token'];
				  $admin->admin_update($fn,$ln,$un,$ad,$ad2,'img',$hidden_img,$tkn);	  
            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="row-fluid">
						...
						<div class="box gradient">
                                ...
                                <div class="title">
                                    <h4>
                                        <span class="eco-list ">Account settings</span>                                         
                              ...
                              <form class="form-horizontal" id="form-validate" action="<?php echo $_['action']; ?>" method="post" enctype="multipart/form-data">           
                                ...
                                <div class="tab-content">
										...
										<div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input type="text" class="span9 required " id="required" value="<?php echo $admin->admin_data('user_first_name')?>" name="fn" placeholder="Admin First Name"  />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input type="text" class="span9 " id="required" value="<?php echo $admin->admin_data('user_last_name') ?>" name="ln"placeholder="Admin Last Name"  />
                                                </div>
                                            </div>
                                        </div>                                        
                                        <div class="form-row row-fluid">
                                            <div class="span12">
												...
												<label class="form-label span2" for="required">Username</label>
                                                    <input type="text" class="span9 " value="<?php echo $admin->admin_data('user_username') ?>" id="required" placeholder="Username" name="un"  />
                                                </div>
                                            </div>
                                        </div>                                                                               
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input type="text"  class="span9 required" id="email"value="<?php echo $admin->admin_data('user_email'); ?>" name="em"placeholder="Email" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Address </label>
						                                  ...
						                                  <div class="form-row">
						                                      <textarea class="" name="ad" style="width:73%; height:100px"><?php echo $admin->admin_data('user_address'); ?></textarea>
						                                  </div>
                                            ...
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Address 2</label>
						                                  ...
						                                  <div class="form-row">
						                                      <textarea class="" name="ad2" style="width:73%;height:100px"><?php echo $admin->admin_data('user_address2'); ?></textarea>
						                                  </div>
                                        ...
                                        <div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">											
													<label class="form-label span2" for="username">Store logo </label>
                                                  <img id="uploadPreview" style="height:60px; width:60px; " data-placeholder="images/Blank-person-photo-e1372195842442.png" src="../<?php echo $admin->admin_data('user_img');?>" border="1px" class="image marginR10"/>
