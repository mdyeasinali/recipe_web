<?php 
  ...
  $admin->check_admin_token($token);
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
			  ...
			  $slider->add_slider($sl_name,$sl_url,$st,$tkn,'img');
                                    ...
                                    <div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												...
												<input type="text" class="span9 required " id="required"  name="ct" placeholder="Slider Title "  />
											</div>
										</div>
									</div>  
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												<label class="form-label span2" for="required">Slider URL</label>
												<input type="text" class="span9 " id="required" name="url"placeholder="Slider URL"  />
											</div>
										</div>
									</div>
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">												
												<label class="form-label span2" for="username">Slider Image</label>
										...
										<div class="span12">
											<div class="row-fluid">												
												...
												<div class="left marginR10">
													<input type="checkbox" id="inlineCheckbox4" name="status" checked="checked" class="ibutton nostyle" /> 
												</div>
											</div>
										</div>
									</div>
