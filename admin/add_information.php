<?php 
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){
	  if(empty($_REQUEST['it'])||
		empty($_REQUEST['infod']))
		{
		 	$admin->url_return(array('add_information.php','Some of fields is empty','eror',$_POST['token']));
		  }else{
			   	 $it = $_POST['it'];
				  $ifd = $_POST['infod'];
				  $mtt = $_POST['mtt'];
				  ...
				  if(empty($_POST['itop'])){
				   ...
				   $tkn = $_POST['token'];
				  $information->add_information($it,$ifd,$mtt,$mtd,$mtk,$itop,$tkn);	  
				  }
            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="row-fluid">
						...
						<div class="box gradient">
                                ...
                                <div class="title">
                                    <h4>
                                        <span class="eco-list ">Add Information</span>                                         
										...
										<div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input type="text" class="span9 required " id="required"  name="it" placeholder="Information Title"  />
                                                </div>
                                            </div>
                                        </div>
										<div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Description</label>
													  ...
													  <div class="form-row">
														  <textarea class="tinymce" name="infod" style="width:74%;"></textarea>
													  </div>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input type="text" class="span9 " id="required" name="mtt"placeholder="Meta Title"  />
                                                </div>
                                            </div>
                                        </div>
										<div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Meta Tag Description</label>
													  ...
													  <div class="form-row">
														  <textarea class="" name="mtd" style="width:74%;"></textarea>
													  </div>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    ...
                                                    <input type="text" class="span9 " id="required" name="mtk"placeholder="Meta Title"  />
                                                </div>
                                            </div>
                                        </div>
										<div class="form-row row-fluid">
											...
											<div class="span12">
												<div class="row-fluid">												
													...
													<div class="left marginR10">
														<input type="checkbox" id="inlineCheckbox4" name="itop" checked="checked" class="ibutton nostyle" /> 
													</div>
												</div>
											</div>
										</div>
