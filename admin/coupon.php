<?php 
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){		
	...
	$Recipe->delete_Recipe($delecte_id,$tkn);
	}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
<?php 
if($admin->admin_data('user_role')== '1'){
	include('header.php');
	}else{
                              ...
                              <div class="box gradient">
                                 ...
                                 <div class="title">
                                      <h4>
                                          ...
                                          <a href="add_Recipe.php<?php echo $_['url_prm']; ?>"><span class="label btn btn-primary btn-mini">Add New</span></a>
                                      </h4>
                                  </div>
                                         ...
                                         <thead>
                                          ...
                                          <tbody>
                                            ...
                                            <td class="chChildren"><input type="checkbox" name="check_list[]" value="<?php echo $key['id']; ?>" class="styled" /></td>
                                                ...
                                                <td><?php echo  $key['co_feature']; ?></td> 
                                                <td><?php echo  $key['status']; ?></td>                                                
                                                <td>
  													<div class="controls center">
  														<a href="edit_Recipe.php?cou_id=<?php echo $key['id']; ?>&token=<?php echo $token ?>" title="Edit task"  class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
