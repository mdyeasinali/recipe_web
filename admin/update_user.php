<?php 
  ...
  require_once('../include/users_class.php');
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){
				  ...
				  $users->users_update($fn,$ln,$em,$un,$ad,$ad2,'img',$hidden_img,$tkn,$u_id);  
            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Partner Page</li>
                    </ul>
                ...
                <div class="row-fluid">
						...
						<div class="box gradient">
                                ...
                                <div class="title">
                                    <h4>
                                        <span class="eco-list ">Add Partner</span>                                         
                             ...
                             <div class="content noPad clearfix">
                              <form class="form-horizontal" id="form-validate" action="<?php echo $_['action']; ?>" method="post" enctype="multipart/form-data">           
                                ...
                                <div class="tab-content"> 
                                    ...
                                    <?php $row = $users->update_show_user($u_id); foreach($row as $val){ ?>
                                    <input type="hidden" name="hidden_img" value="<?php echo $val['user_img']; ?>" />	
									
									 
										<div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">First Name</label>
                                                    <input type="text" class="span9 required " id="required"  name="fn" value="<?php echo $val['fname']; ?>" placeholder="Partner First Name"  />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Last Name</label>
                                                    <input type="text" class="span9 required" id="required" name="ln"value="<?php echo $val['lname']; ?>" placeholder="Partner Last Name"  />
                                                </div>
                                            </div>
                                        </div>                                        
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
												<label class="form-label span2" for="required">User Name</label>
                                                    <input type="text" class="span9 required" id="required" placeholder="Username" name="un" value="<?php echo $val['uname']; ?>"  />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
												<label class="form-label span2" for="required">Password</label>
                                                    <input type="password" class="span9 " id="required" placeholder="Username" name="pw"  value="<?php echo $val['upass']; ?>"/>
                                                </div>
                                            </div>
                                        </div>                                       
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Email</label>
                                                    <input type="text"  class="span9 required" id="email" name="em" value="<?php echo $val['uemail']; ?>" placeholder="Email"  />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Address </label>
                                                    
						                                  <div class="form-row">
						                                      <textarea class="" name="ad" style="width:73%; height:100px"><?php echo $val['uadd']; ?></textarea>
						                                  </div>
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="row-fluid">
                                                    <label class="form-label span2" for="required">Address 2</label>
                                                    
						                                  <div class="form-row">
						                                      <textarea class="" name="ad2" style="width:73%;height:100px"><?php echo $val['uadd2']; ?></textarea>
						                                  </div>
                                        ...
                                        <div class="form-row row-fluid">
											<div class="span12">
												<div class="row-fluid">											
													<label class="form-label span2" for="username">Image</label>
                                                  <img id="uploadPreview" style="height:60px; width:60px; " data-placeholder="images/Blank-person-photo-e1372195842442.png"  src="../<?php echo $val['user_img'];?>"  border="1px" class="image marginR10"/>
