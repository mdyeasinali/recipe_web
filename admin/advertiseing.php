<?php 
  ...
  $admin->check_admin_token($token);
   ...
   if($_SERVER['REQUEST_METHOD'] == "POST"){		
	...
	$advertise->delete_adv($delecte_id,$tkn);		
	} 
                ...
                <div id="content" class="clearfix">
                    ...
                    <div class="heading">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="active">Advertiseing Page</li>
                        </ul>
                    ...
                    <!-- Build page from here: -->
                          ...
                          <div class="span12">
                              ...
                              <div class="box gradient">
                                 ...
                                 <div class="title">
                                      <h4>
                                          <span>All Advertiseing</span>
  										<a href="#"onclick="confirm_delete()" id="delete"><span class=" label btn btn-danger btn-mini">Delete</span></a>
                                          <a href="add_advertiseing.php<?php echo $_['url_prm']; ?>"><span class="label btn btn-primary btn-mini">Add New</span></a>
                                      </h4>
                                  </div>
                                         ...
                                         <thead>
                                          ...
                                          <tbody>
                                            ...
                                            <tr class="even gradeC">
                                                ...
                                                <td><?php echo  $key['ad_title']; ?></td> 
                                                <td><?php  echo  $key['ad_footer'];  ?></td>                                                
                                                <td><?php   echo  $key['ad_c_page'];  ?></td>                                                
                                                <td><?php  echo  $key['ad_cat']; ?></td>                                                
                                                <td><?php  echo  $key['ad_st'];  ?></td>                                                
                                                <td>
  													<div class="controls center">
  														<a href="edit_advertiseing.php?adv_id=<?php  echo $key['id']; ?>&token=<?php echo $token ?>" title="Edit task"  class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
