<?php 
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){
		if(empty($_REQUEST['ad_title'])){
		 	$admin->url_return(array('add_advertiseing.php','Some of fields is empty','eror',$_POST['token']));
		  }else{		  	
			  ...
			  $advertise->add_adv($ad_title, $ad_des, $ad_footer, $ad_c_page, $ad_cat, $ad_st, $tkn);
		  }
	}
            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Add Advertiseing Page</li>
                    </ul>
                ...
                <div class="row-fluid">
						...
						<div class="box gradient">
                               ...
                               <div class="title">
                                    <h4>
                                        <span class="eco-list ">Add Advertiseing</span>                                         
                                    ...
                                    <div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												...
												<input type="text" class="span9 required " id="required"  name="ad_title" placeholder="Advertiseing Title "  />
											</div>
										</div>
									</div>                                
                                    <div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												...
												<textarea type="text" class="span9 required " id="required"  name="ad_url" placeholder="Advertiseing Title " ></textarea>
											</div>
										</div>
									</div>
									<!---
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">												
												...
												<img  id="uploadPreview"  style="height:70px; width:70px;" data-placeholder="" class="image marginR10" src="images/defalt-image.png" alt="" >
									...
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">
												...
												<input type="text" class="span9 " id="required" name="ad_url"placeholder="Advertiseing URL"  />
											</div>
										</div>
									</div>
									--->
										...
										<div class="span12">
											<div class="row-fluid">												
												...
												<div class="left marginR10">
													<input type="checkbox" id="inlineCheckbox4" name="ad_footer" checked="checked" class="ibutton nostyle" /> 
												</div>
											</div>
										</div>
									</div>
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">												
												...
												<div class="left marginR10">
													<input type="checkbox" id="inlineCheckbox4" name="ad_c_page" checked="checked" class="ibutton nostyle" /> 
												</div>
											</div>
										</div>
									</div>
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">												
												...
												<div class="left marginR10">
													<input type="checkbox" id="inlineCheckbox4" name="ad_cat" checked="checked" class="ibutton nostyle" /> 
												</div>
											</div>
										</div>
									</div>
									<div class="form-row row-fluid">
										<div class="span12">
											<div class="row-fluid">												
												...
												<div class="left marginR10">
													<input type="checkbox" id="inlineCheckbox4" name="ad_st" checked="checked" class="ibutton nostyle" /> 
												</div>
											</div>
										</div>
									</div>
