...
<!-- Mirrored from demos.pixelatethemes.com/recipex/ by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Apr 2017 17:53:36 GMT -->
<head>
	<meta charset="UTF-8">
	...
	<div class="thm-container clearfix">
		...
		<div class="nav-holder pull-right">
			...
			<div class="nav-footer">
				<ul class="nav">
					<li><a href="index-2.html"><i class="flaticon-food"></i>Home</a></li>		
		...
		<ul>
			...
			<li data-transition="parallaxvertical" data-ease="SlowMo.ease">
				...
				<div class="tp-caption sfb tp-resizeme" 
			        ...
			        data-start="500">
					<img src="images/slider/image-1.png" alt="Awesome Image"/>
			    </div>
				...
				<div class="tp-caption sfl tp-resizeme caption-p" 
			        ...
			        data-transform_out="o:0" 
			        data-start="1500">
					Neque porro quisquam est, qui dolorem ipsum quia <br> dolor sit amet, consectetur, adipisci velit, sed quia non <br> numm eius modi tempora incidunt.
			    </div>
					...
					<div class="col-md-12">
		                ...
		                <ul class="special-checkbox">
		                    ...
		                    <li>
		                    	<span class="input-checker">
									<input type="checkbox" value="">
		                    	</span>Vegetalbe Mix</li>
		                    <li>
		                    	<span class="input-checker">
									<input type="checkbox" value="">
		                    	</span>Chicken Masala</li>
		                    <li>
		                    	<span class="input-checker">
									<input type="checkbox" value="">
		                    	</span>Soup</li>
	...
	<div class="thm-container">
		...
		<div class="owl-carousel owl-theme">
			<div class="item">
				<div class="single-recent-recipes img-cap-effect">
					<div class="img-box">
						<img src="images/top-recipes/1.jpg" alt="">
						<div class="img-caption">
							<div class="box-holder">
								<ul>
									<li><a href="#"><i class="icon icon-Goto"></i></a></li>
			...
			<div class="item">
				<div class="single-recent-recipes img-cap-effect">
					<div class="img-box">
						<img src="images/top-recipes/2.jpg" alt="">
						<div class="img-caption">
							<div class="box-holder">
								<ul>
									<li><a href="#"><i class="icon icon-Goto"></i></a></li>
...
<section class="testimonails-recipex">
	<div class="thm-container">
			...
			<ul class="slides">
				<li class="slide">
					<div class="col-lg-6 full-image">
						<img src="images/testimonials/1.jpg" alt="Awesome Image"/>
				...
				<li class="slide">
					<div class="col-lg-6 full-image">
						<img src="images/testimonials/2.jpg" alt="Awesome Image"/>
				...
				<li class="slide">
					<div class="col-lg-6 full-image">
						<img src="images/testimonials/3.jpg" alt="Awesome Image"/>
		...
		<ul class="custom-pager">
			<li data-slide-index="0"><span><img src="images/testimonials/1.png" alt="Awesome Image"/></span></li>
			<li data-slide-index="1"><span><img src="images/testimonials/2.png" alt="Awesome Image"/></span></li>
			<li data-slide-index="2"><span><img src="images/testimonials/3.png" alt="Awesome Image"/></span></li>
		</ul>
	...
	<div class="thm-container">	
		...
		<div class="row">
			<div class="col-lg-6 col-md-12 col-sm-12">
				...
				<div class="single-blog-post img-cap-effect">
					<div class="img-box">
						<img src="images/blog/2.jpg" alt="Awesome Image"/>
						<div class="img-caption">
							<div class="box-holder">
								<ul>
									<li><a href="#"><i class="icon icon-Goto"></i></a></li>
			...
			<div class="col-md-6 hidden-md col-sm-12">
				<div class="promotion">
					...
					<p>Connect and interact with other <br>cooks who have the same interests <br>as you. It’s fun and super easy to get <br>started!</p>
...
<!-- Mirrored from demos.pixelatethemes.com/recipex/ by HTTrack Website Copier/3.x [XR&CO'2013], Sun, 30 Apr 2017 17:56:07 GMT -->
</html>